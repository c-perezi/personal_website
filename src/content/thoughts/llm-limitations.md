...
A personal concern that highlights the limitations of LLMs is misuse by the widespread public. The fact that these models have been democratized is a great asset. However, certain models are prone to sycophancy, which may affect mental health. In an era where far too many people are isolated from social interactions, replacing this intrinsically human need for the use of an LLM can cause more harm, particularly if it is wired to agree with the person, resulting in unfounded convictions or so-called "AI psychosis".   